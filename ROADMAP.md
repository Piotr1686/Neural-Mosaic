...
- [x] **Sprint 2.2** — Loader: thumbnail grid (lazy, np. 200x200 cache w `data/.thumbs/`).
...
- [x] **Sprint 2.5** — Akcje: usuń/oznacz kafelek, eksport listy "bad tiles" do `data/library_*/excluded.txt`.
