...
**Krok 5.1 — `src/tools/make_dzi.py`** (Deep Zoom tile viewer)

Wg MASTER_PLAN_v6.4.md, sekcja Faza 5. Skrypt generuje kafelki DZI (Deep Zoom Image) z mozaiki 16K do folderu `docs/tiles/` — umożliwia przeglądanie w przeglądarce bez pobierania całego 16K pliku.
...
- ⟳ Krok 5.1: `src/tools/make_dzi.py` — Deep Zoom viewer
...
- `MASTER_PLAN_v6.4.md` — committed `e35dcf1`
- `MODEL_ROUTING.md` — committed `e35dcf1`
